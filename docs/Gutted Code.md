...
void MachineSetup() {
  ...
  // };
  setIdleMenu();
  Serial.println("DEBUG: Menu Should be updated");
  printHeaderAndMenu();
  OperationMode = 0;
}
```
  ...
  while(OperationMode ==2) {
    switch(task) {
      ...
      case 0:
        ...
        // Serial.println("Welcome to Automatic Mode!");
        Serial.println("Please enter the 1st combination number.");


        combo1 = getCombination(number);
        // wait for input of combo1 with function: 
      ...
      case 2:
        Serial.println("Please enter the 2nd combination number.");
        ...
        break;
      case 3:
        Serial.println("Please enter the 3rd combination number.");
...
String machineMessage, menuTitle, action1, action2, action3, action4;
...
void drivePulses(int distInPulses) {
  ...
  while(1) {
    ...
    // Serial.print("DEBUG: distInPulses: ");
    // Serial.println(distInPulses);
    // Serial.print("DEBUG: PWM_value: ");
    // Serial.println(PWM_value);
    // Serial.print("DEBUG: encoderPos: ");
...
// set idle menu
void setIdleMenu() {
  Serial.println("DEBUG: Idle Menu Set");
  ...
  action1 =   "1. Manual Operation";
  action2 =   "2. Automatic Operation";
  action3 =   "3. Machine Data Set-Up";
  action4 =   "5. Exit";

  menuTitle[24] = '\0';  // Ensure null termination
  action1[24] = '\0';
  action2[24] = '\0';
  action3[24] = '\0';
  action4[24] = '\0';
  ...
  Serial.print("DEBUG MENU TITLE: "); Serial.print(menuTitle); Serial.println("AFTER??"); // Debug print
...
void setManualMenu() {
  ...
  action1 =   "1. Move One Tick CW";
  action2 =   "2. Move One Tick CCW";
  action3 =   " ";
  action4 =   "5. Exit";
}
...
void setAutomaticMenu() {
  ...
  // str2 = "You will be prompted to";
  // str3 = "enter a three numbers";
  // str4 = " ";
  // str5 = " ";
  // str1.toCharArray(menuTitle,25);
  // str2.toCharArray(action1, 25);
  ...
  // str4.toCharArray(action3, 25);
  // str5.toCharArray(action4, 25);
  menuTitle = "AUTOMATIC MENU";
  action1 =   "You will be prompted";
  action2 =   "enter a three numbers";
  action3 =   " ";
  action4 =   " ";
}
...
void setSetupMenu() {
  ...
  // str2 = "Input a value for the ";
  // str3 = "initial dial position.";
  // str4 = " ";
  // str5 = " ";
  // str1.toCharArray(menuTitle,25);
  // str2.toCharArray(action1, 25);
  ...
  // str4.toCharArray(action3, 25);
  // str5.toCharArray(action4, 25);
  menuTitle = "MACHINE SETUP MENU";
  action1 =   "Input a value for the ";
  action2 =   "initial dial position.";
  action3 =   " ";
  action4 =   " ";
}
...
int getCombination(char *arr) {
  ...
  while(inputFlag) {
    ...
    if (dialPosition >= 0 && dialPosition <= dial_ticks) {
      //Set Dial position if it is an appropriate option
      Serial.println("Combination Number Accepted!"); 
      Serial.println(); 
      //Give option to leave program or not
      inputFlag = 0;
      return dialPosition;
      ...
      // Serial.print("Invalid Number Input: "); Serial.println(dialPosition);
      Serial.println("That combination is invalid!");
      Serial.print("Input should be from 0-"); Serial.println(dial_ticks);
      Serial.println("Please try again.\n");
      // dialPosition = getTwoCharDigits(numbers);
    }
  }
}
...
void MachineSetup() {
  ...
  // Serial.println("DEBUG: Input a value for the initial dial position: ");
  // Serial.print("DEBUG: Input a value for the initial dial position: ");
...
void ManualOperation(char selection) {
  ...
  if (selection) {
    ...
    machineMessage = "Manual Idle Mode";
    // str = "Manual Idle Mode";
    // str.toCharArray(machineMessage,25);
    switch (selection) {
      case '1': 
        machineMessage = "Manual Active Mode";
